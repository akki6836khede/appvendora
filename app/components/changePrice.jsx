...
const ChangePrice = ({ _id, setShowAdder }) => {
    const handleSubmit = async (formData) => {
        const result = await updateStockOrPrice(formData, "price");
        if (result.succes) {
    ...
    return (
        ...
        >
            ...
            <button type='submit' className='w-28 h-8 flex justify-center items-center rounded-lg bg-gradient-to-br from-blue-400 to-blue-700 text-white font-bold'>
                Change Price
            </button>
        </Form>
    )
